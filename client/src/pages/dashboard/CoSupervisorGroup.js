...
const CoSupervisorGroup = () => {
    const { getCoSupervisorGroup, supervisorGroup, isLoading,user } = useAppContext();
  useEffect(() => {
...
return ( 
    <Wrapper>
      ...
      <div className="content">
        ...
        <div className="content">
            <Link to='/cosupervisormessage' className="btn edit-btn">
              Message
            </Link>
        </div>
      </div>
...
export default CoSupervisorGroup
